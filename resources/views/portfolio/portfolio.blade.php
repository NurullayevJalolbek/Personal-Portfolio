  ...
  <body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <section id="home" class="hero-section">
      <div class="container text-center hero-content">
        ...
        <h2
          class="typing-text animate__animated animate__fadeIn animate__delay-1s"
        ></h2>
        <p
          class="hero-description animate__animated animate__fadeIn animate__delay-1s"
        >
          Crafting high-performance backend systems with
          <span class="code-style">PHP</span>,
          <span class="code-style">Laravel</span>, and
          <span class="code-style">MySQL</span>. Focused on clean architecture,
          scalability, and security.
        </p>
        <div
          class="d-flex justify-content-center gap-3 animate__animated animate__fadeIn animate__delay-2s"
        >
    ...
    <section id="projects" class="projects-section py-5">
      <div class="container py-5">
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-4">
            ...
            >
              ...
              <div class="card-footer">
                <a
                  href="https://github.com/NurullayevJalolbek/ecommerce-platform"
                  target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div
              class="project-card animate__animated animate__fadeInUp animate__delay-1s"
              data-bs-toggle="modal"
            ...
            >
              ...
              <div class="card-footer">
                <a
                  href="https://github.com/NurullayevJalolbek/crm-system"
                  target="_blank"
                  class="btn btn-outline-light btn-sm me-2"
                >
                  <i class="fab fa-github me-1"></i> Code
          ...
          <div class="col-md-6 col-lg-4">
            <div
              class="project-card animate__animated animate__fadeInUp animate__delay-2s"
              data-bs-toggle="modal"
            ...
            >
              ...
              <div class="card-footer">
                <a
                  href="https://github.com/NurullayevJalolbek/api-service"
                  target="_blank"
                  class="btn btn-outline-light btn-sm me-2"
                >
                  <i class="fab fa-github me-1"></i> Code
    ...
    <section id="skills" class="skills-section py-5">
      <div class="container py-5">
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div
              class="skill-card animate__animated animate__fadeIn animate__delay-1s"
            >
          ...
          <div class="col-md-6 col-lg-3">
            <div
              class="skill-card animate__animated animate__fadeIn animate__delay-2s"
            >
              <h3 class="skill-title">
          ...
          <div class="col-md-6 col-lg-3">
            <div
              class="skill-card animate__animated animate__fadeIn animate__delay-3s"
            >
              <h3 class="skill-title">
