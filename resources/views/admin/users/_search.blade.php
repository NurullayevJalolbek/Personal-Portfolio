<div class="col-md">
    <div class="card card-action mb-2">
        {{-- <div class="card-header">
            <div class="card-action-title">Search</div>
        ...
        <div class="collapse show">
            <div class="card-body pt-0 mt-3">
                <form class="dt_adv_search" action="{{ route('admin.users.index') }}" method="GET">
                    @csrf
                    <div class="row">
                        <div class="col-md-7">
                            <x-form.label-input name="search" label="{{ __('admin.Fullname') }}"
